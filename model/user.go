...
type User struct {
	...
	CaptchaId        string                     `json:"captcha_id" gorm:"-:all"`                                // graphical captcha id, never persisted
	CaptchaCode      string                     `json:"captcha_code" gorm:"-:all"`                              // graphical captcha answer submitted by the user, never persisted
